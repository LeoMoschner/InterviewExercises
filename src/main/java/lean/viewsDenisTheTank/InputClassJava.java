...
public class InputClassJava {
    ...
    static String inputString = "2023-01-26\n" +
            "2023-02-03,android,1336061,375491,iOS,985014,418290,mobileWeb,336195,198403,newReddit,267522,140548,oldReddit,957462,189477\n" +
            "2023-02-05,android,1153728,298063,iOS,755030,311642,mobileWeb,219457,130288,newReddit,221081,111902,oldReddit,723509,132801\n" +
            "2023-02-04,android,1291546,280199,iOS,575184,257443,mobileWeb,191464,116411,newReddit,225093,118371,oldReddit,760191,145437\n" +
            "2023-02-01,android,1613490,331628,iOS,626490,288464,mobileWeb,193197,111844,newReddit,300378,175446,oldReddit,830788,164052\n" +
    ...
    public static Map<String, DateEntry> generateDataInMapFormat() {
